...
import { Zap, Sparkles, MessageCircle, Brain, Heart, Activity, CheckCircle2, Gift, Phone, Crown } from "lucide-react";
...
const Services = ({ children }: { children?: ReactNode }) => {
  ...
  // Ordre arrêté avec Vincent le 2026-07-28, sur les ventes réelles (Daily report
  // juin→juillet 2026 + audit stock du 20/07 + audit 90 j du 27/07) : NAD+ 250mg
  // est le n°1 clinique, Glutathione pesait ฿164 750 / 90 j sans aucune card.
  // Fat Burner, Curcumin et Resveratrol seul sortent de la vedette — ils restent
  // listés plus bas dans Body Booster.
  const popularDrips = [
    {
      icon: Zap,
