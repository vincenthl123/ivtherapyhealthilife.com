...
const translations = {
  en: {
    ...
    // Medical Team
    "team.title": "Meet the Experts Behind Your Regeneration",
    "team.subtitle": "Trusted doctors. Proven results. Premium care.",
  ...
  th: {
    ...
    // Medical Team
    "team.title": "พบกับผู้เชี่ยวชาญเบื้องหลังการฟื้นฟูของคุณ",
    "team.subtitle": "แพทย์ที่ไว้วางใจได้ ผลลัพธ์ที่พิสูจน์แล้ว การดูแลระดับพรีเมียม",
    "team.drPetch.name": "นพ. เพ็ชร (ศรัสวดี สุวรรณจินดา)",
    "team.drPetch.role": "ผู้ก่อตั้งและผู้เชี่ยวชาญด้านเวชศาสตร์ไลฟ์สไตล์ - แพทย์",
    "team.drFirst.name": "นพ. เฟิร์ส (นภัส หุ่นสจะรูปัน)",
    "team.drFirst.role": "ผู้ก่อตั้งและแพทย์",
