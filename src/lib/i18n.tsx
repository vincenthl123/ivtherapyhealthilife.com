...
const translations = {
  en: {
    ...
    "package.fatBurner10.title": "FAT BURNER — 10 SESSIONS",
    "package.fatBurner10.subtitle": "Maximum Transformation & Metabolic Mastery",
    "package.fatBurner10.price": "36,000 THB",
    "package.fatBurner10.pricePerSession": "3,600 THB/session (Save 20%)",
    "package.fatBurner10.desc": "The ultimate fat-burning commitment. 10 sessions for deep metabolic reprogramming, sustained body recomposition, and long-term results.",
    "package.fatBurner10.highlight": "10 Sessions — Deep Metabolic Reset — Complimentary Foot Massage",
  ...
  th: {
    ...
    "package.fatBurner10.title": "FAT BURNER — 10 เซสชัน",
    "package.fatBurner10.subtitle": "การเปลี่ยนแปลงสูงสุด & ควบคุมการเผาผลาญ",
    "package.fatBurner10.price": "36,000 บาท",
    "package.fatBurner10.pricePerSession": "3,600 บาท/เซสชัน (ประหยัด 20%)",
    "package.fatBurner10.desc": "ความมุ่งมั่นสูงสุดในการเผาผลาญไขมัน 10 เซสชันเพื่อรีเซ็ตการเผาผลาญอย่างล้ำลึก ปรับรูปร่างอย่างยั่งยืน",
    "package.fatBurner10.highlight": "10 เซสชัน — รีเซ็ตการเผาผลาญเชิงลึก — นวดเท้าฟรี",
  ...
  ja: {
    ...
    "package.fatBurner10.title": "ファットバーナー — 10セッション",
    "package.fatBurner10.subtitle": "最大変革 & 代謝マスタリー",
    "package.fatBurner10.price": "36,000 バーツ",
    "package.fatBurner10.pricePerSession": "3,600 バーツ/セッション（20%お得）",
    "package.fatBurner10.desc": "究極の脂肪燃焼コミットメント。10セッションで深い代謝リプログラミング、持続的なボディリコンポジション、長期的な結果。",
    "package.fatBurner10.highlight": "10セッション — 深い代謝リセット — フットマッサージ付き",
