...
const translations = {
  en: {
    ...
    "pathway.vitalReset.day1Desc": "IV Alpha Lipoic Acid + NAD+ 250mg — mitochondrial antioxidant support & cellular energy activation",
  ...
  th: {
    ...
    "pathway.vitalReset.day1Desc": "IV Alpha Lipoic Acid + NAD+ 250mg — สนับสนุนสารต้านอนุมูลอิสระไมโตคอนเดรีย & กระตุ้นพลังงานเซลล์",
  ...
  ja: {
    ...
    "pathway.vitalReset.day1Desc": "IV α-リポ酸 + NAD+ 250mg — ミトコンドリア抗酸化サポート＆細胞エネルギー活性化",
