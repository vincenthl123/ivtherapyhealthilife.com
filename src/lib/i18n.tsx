...
const translations = {
  ...
  ja: {
    ...
    "whatsapp.welcome": "Healthi-Lifeへようこそ！💉✨",
    "whatsapp.message": "エネルギー、活力、最高のパフォーマンスのためのパーソナライズドIV療法。健康を最適化する準備はできましたか？",
    ...
    "services.discoverMore": "健康ニーズに合わせた21種類以上のIV点滴をご用意",
