...
const translations = {
  en: {
    ...
    "pathway.vitalReset.nadHighlight": "⭐ 3 Days — 500mg NAD+",
    "pathway.vitalReset.governedLabel": "Physician-Governed Cellular Activation",
    "pathway.vitalReset.title": "VITAL RESET",
    "pathway.vitalReset.subtitle": "Foundational Energy & Metabolic Recalibration",
    "pathway.vitalReset.desc": "Designed for individuals experiencing sustained fatigue, stress overload, metabolic instability, or disrupted biological rhythm.",
    "pathway.vitalReset.notIsolated": "Vital Reset is not an isolated intervention.",
    "pathway.vitalReset.notIsolated2": "It is a structured entry into physician-led optimization.",
    "pathway.vitalReset.supportsTitle": "What This Pathway Supports",
    "pathway.vitalReset.support1": "Mitochondrial energy activation",
    "pathway.vitalReset.support2": "Metabolic recalibration",
    "pathway.vitalReset.support3": "Hormonal rhythm stabilization",
    "pathway.vitalReset.support4": "Systemic inflammation modulation",
    "pathway.vitalReset.beforePerformance": "Before performance comes stability.",
    "pathway.vitalReset.beforeIntensity": "Before intensity comes biological clarity.",
    "pathway.vitalReset.phaseTitle": "Structured 3-Day Phase",
    "pathway.vitalReset.phaseSubtitle": "(500mg NAD+ — Doctor Recommendation)",
    "pathway.vitalReset.phaseDesc": "Delivered within a controlled medical framework, this phase initiates cellular activation and metabolic reinforcement under supervision.",
    "pathway.vitalReset.adjustedTitle": "Each step is adjusted based on:",
    "pathway.vitalReset.adjusted1": "Clinical evaluation",
    "pathway.vitalReset.adjusted2": "Biomarker profile",
    "pathway.vitalReset.adjusted3": "Lifestyle demands",
    "pathway.vitalReset.adjusted4": "Physiological response",
    "pathway.vitalReset.protocolNote": "Protocol specifics are determined at consultation.",
    "pathway.vitalReset.oversightTitle": "Clinical Oversight",
    "pathway.vitalReset.oversightIntro": "Every Vital Reset pathway includes:",
    "pathway.vitalReset.oversight1": "Targeted baseline assessment",
    "pathway.vitalReset.oversight2": "Physician-guided sequencing",
    "pathway.vitalReset.oversight3": "Structured monitoring phase",
    "pathway.vitalReset.oversight4": "Personalized adjustment strategy",
    "pathway.vitalReset.noPathway": "No pathway is identical.",
    "pathway.vitalReset.standardized": "Structure is standardized. Application is individualized.",
    "pathway.vitalReset.price": "Starting from 50,000 THB",
    "pathway.vitalReset.duration1": "5–7 day core phase",
    "pathway.vitalReset.duration2": "30-day monitoring window",
    "pathway.vitalReset.cta": "Book Your Medical Review",
  ...
  th: {
    ...
    // Vitality Pathway
    "services.vitalityPathway": "VITALITY PATHWAY",
    "pathway.vitalReset.nadHighlight": "⭐ 3 วัน — NAD+ 500mg",
    "pathway.vitalReset.governedLabel": "การกระตุ้นเซลล์ภายใต้การดูแลของแพทย์",
    "pathway.vitalReset.title": "VITAL RESET",
    "pathway.vitalReset.subtitle": "ฟื้นฟูพลังงานพื้นฐาน และปรับสมดุลการเผาผลาญ",
    "pathway.vitalReset.desc": "ออกแบบสำหรับผู้ที่มีอาการเหนื่อยล้าเรื้อรัง ความเครียดสะสม ความไม่สมดุลของเมตาบอลิซึม หรือจังหวะชีวภาพที่ผิดปกติ",
    "pathway.vitalReset.notIsolated": "Vital Reset ไม่ใช่การรักษาแบบแยกส่วน",
    "pathway.vitalReset.notIsolated2": "แต่เป็นจุดเริ่มต้นของการปรับสมดุลภายใต้การดูแลของแพทย์",
    "pathway.vitalReset.supportsTitle": "สิ่งที่โปรแกรมนี้สนับสนุน",
    "pathway.vitalReset.support1": "กระตุ้นพลังงานไมโตคอนเดรีย",
    "pathway.vitalReset.support2": "ปรับสมดุลการเผาผลาญ",
    "pathway.vitalReset.support3": "ปรับจังหวะฮอร์โมนให้คงที่",
    "pathway.vitalReset.support4": "ปรับการอักเสบทั้งระบบ",
    "pathway.vitalReset.beforePerformance": "ก่อนประสิทธิภาพ ต้องมีเสถียรภาพ",
    "pathway.vitalReset.beforeIntensity": "ก่อนความเข้มข้น ต้องมีความชัดเจนทางชีวภาพ",
    "pathway.vitalReset.phaseTitle": "ระยะ 3 วันแบบมีโครงสร้าง",
    "pathway.vitalReset.phaseSubtitle": "(NAD+ 500mg — แนะนำโดยแพทย์)",
    "pathway.vitalReset.phaseDesc": "ดำเนินการภายในกรอบการแพทย์ที่ควบคุม ระยะนี้เริ่มต้นการกระตุ้นเซลล์และเสริมสร้างเมตาบอลิซึมภายใต้การดูแล",
    "pathway.vitalReset.adjustedTitle": "แต่ละขั้นตอนปรับตาม:",
    "pathway.vitalReset.adjusted1": "การประเมินทางคลินิก",
    "pathway.vitalReset.adjusted2": "โปรไฟล์ไบโอมาร์กเกอร์",
    "pathway.vitalReset.adjusted3": "ความต้องการด้านไลฟ์สไตล์",
    "pathway.vitalReset.adjusted4": "การตอบสนองทางสรีรวิทยา",
    "pathway.vitalReset.protocolNote": "รายละเอียดโปรโตคอลกำหนดในการปรึกษา",
    "pathway.vitalReset.oversightTitle": "การดูแลทางคลินิก",
    "pathway.vitalReset.oversightIntro": "ทุก Vital Reset pathway รวมถึง:",
    "pathway.vitalReset.oversight1": "การประเมินพื้นฐานเฉพาะจุด",
    "pathway.vitalReset.oversight2": "การจัดลำดับโดยแพทย์",
    "pathway.vitalReset.oversight3": "ระยะการติดตามแบบมีโครงสร้าง",
    "pathway.vitalReset.oversight4": "กลยุทธ์การปรับเฉพาะบุคคล",
    "pathway.vitalReset.noPathway": "ไม่มีโปรแกรมใดเหมือนกัน",
    "pathway.vitalReset.standardized": "โครงสร้างเป็นมาตรฐาน การประยุกต์ใช้เป็นเฉพาะบุคคล",
    "pathway.vitalReset.price": "เริ่มต้นที่ 50,000 บาท",
    "pathway.vitalReset.duration1": "ระยะหลัก 5–7 วัน",
    "pathway.vitalReset.duration2": "ช่วงติดตามผล 30 วัน",
    "pathway.vitalReset.cta": "จองการตรวจประเมินทางการแพทย์",
  ...
  ja: {
    ...
    // Vitality Pathway
    "services.vitalityPathway": "VITALITY PATHWAY",
    "pathway.vitalReset.nadHighlight": "⭐ 3日間 — NAD+ 500mg",
    "pathway.vitalReset.governedLabel": "医師管理下の細胞活性化",
    "pathway.vitalReset.title": "VITAL RESET",
    "pathway.vitalReset.subtitle": "基礎エネルギー＆代謝リキャリブレーション",
    "pathway.vitalReset.desc": "持続的な疲労、ストレス過負荷、代謝不安定、または生体リズムの乱れを経験している方向けに設計。",
    "pathway.vitalReset.notIsolated": "Vital Resetは単独の治療ではありません。",
    "pathway.vitalReset.notIsolated2": "医師主導の最適化への構造化された入口です。",
    "pathway.vitalReset.supportsTitle": "このパスウェイがサポートすること",
    "pathway.vitalReset.support1": "ミトコンドリアエネルギー活性化",
    "pathway.vitalReset.support2": "代謝リキャリブレーション",
    "pathway.vitalReset.support3": "ホルモンリズム安定化",
    "pathway.vitalReset.support4": "全身性炎症調整",
    "pathway.vitalReset.beforePerformance": "パフォーマンスの前に安定性。",
    "pathway.vitalReset.beforeIntensity": "強度の前に生物学的明晰さ。",
    "pathway.vitalReset.phaseTitle": "構造化3日間フェーズ",
    "pathway.vitalReset.phaseSubtitle": "（NAD+ 500mg — 医師推奨）",
    "pathway.vitalReset.phaseDesc": "管理された医療フレームワーク内で提供され、このフェーズは監督下で細胞活性化と代謝強化を開始します。",
    "pathway.vitalReset.adjustedTitle": "各ステップは以下に基づいて調整：",
    "pathway.vitalReset.adjusted1": "臨床評価",
    "pathway.vitalReset.adjusted2": "バイオマーカープロファイル",
    "pathway.vitalReset.adjusted3": "ライフスタイルの要求",
    "pathway.vitalReset.adjusted4": "生理的反応",
    "pathway.vitalReset.protocolNote": "プロトコルの詳細はコンサルテーションで決定されます。",
    "pathway.vitalReset.oversightTitle": "臨床監督",
    "pathway.vitalReset.oversightIntro": "すべてのVital Resetパスウェイには以下が含まれます：",
    "pathway.vitalReset.oversight1": "ターゲットベースライン評価",
    "pathway.vitalReset.oversight2": "医師主導のシーケンシング",
    "pathway.vitalReset.oversight3": "構造化モニタリングフェーズ",
    "pathway.vitalReset.oversight4": "パーソナライズド調整戦略",
    "pathway.vitalReset.noPathway": "同じパスウェイは存在しません。",
    "pathway.vitalReset.standardized": "構造は標準化。適用は個別化。",
    "pathway.vitalReset.price": "50,000バーツから",
    "pathway.vitalReset.duration1": "コアフェーズ5〜7日間",
    "pathway.vitalReset.duration2": "30日間モニタリングウィンドウ",
    "pathway.vitalReset.cta": "メディカルレビューを予約",
