...
const translations = {
  en: {
    ...
    "whatsapp.welcome": "Welcome to Healthi Life — Bangkok's physician-led IV therapy center.",
    "whatsapp.message": "Our IV protocols are medically supervised and tailored to your needs. How may we support you today?",
    ...
    "pathway.vitalReset.duration": "5–7 days (core phase) · 30-day monitoring",
    ...
    "pathway.vitalReset.day1Desc": "IV Alpha Lipoic Acid (ALA 600mg) + NAD+ 250mg — mitochondrial antioxidant support & cellular energy activation",
    ...
    "pathway.vitalReset.day5Desc": "NAD+ 250mg — mitochondrial reinforcement + Vitamin D IM (if clinically indicated)",
    "pathway.vitalReset.nadHighlight": "3 Days — 500mg NAD+ Total (Doctor Recommendation)",
  ...
  th: {
    ...
    "pathway.vitalReset.duration": "5–7 วัน (ช่วงหลัก) · ติดตามผล 30 วัน",
    ...
    "pathway.vitalReset.day1Desc": "IV Alpha Lipoic Acid (ALA 600mg) + NAD+ 250mg — สนับสนุนสารต้านอนุมูลอิสระไมโตคอนเดรีย & กระตุ้นพลังงานเซลล์",
    ...
    "pathway.vitalReset.day5Desc": "NAD+ 250mg — ระยะเสริมความแข็งแกร่งไมโตคอนเดรีย + Vitamin D IM (ตามข้อบ่งชี้ทางคลินิก)",
    "pathway.vitalReset.nadHighlight": "3 วัน — NAD+ รวม 500mg (แนะนำโดยแพทย์)",
  ...
  ja: {
    ...
    "pathway.vitalReset.duration": "5〜7日間（コアフェーズ）· 30日間モニタリング",
    ...
    "pathway.vitalReset.day1Desc": "IV α-リポ酸（ALA 600mg）+ NAD+ 250mg — ミトコンドリア抗酸化サポート＆細胞エネルギー活性化",
    ...
    "pathway.vitalReset.day5Desc": "NAD+ 250mg — ミトコンドリア強化フェーズ + ビタミンD IM（臨床的に必要な場合）",
    "pathway.vitalReset.nadHighlight": "3日間 — NAD+ 合計500mg（医師推奨）",
